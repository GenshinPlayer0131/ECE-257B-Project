...
public class Configs {
    ...
    private Boolean storeData = null;
    ...
    public boolean getStoreData() {
        if (this.storeData == null) {
            this.storeData = Boolean.parseBoolean(configDocument.getElementsByTagName("store_data").item(0).getTextContent());
        }
